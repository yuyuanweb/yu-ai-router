...
class LatencyFirstRoutingStrategy(RoutingStrategy):
    ...
    @staticmethod
    def _latency_order():
        return case((Model.avg_latency == 0, 999999), else_=Model.avg_latency).asc()
